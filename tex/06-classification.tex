...
\caption{Сравнение методов анализа тональности\label{tbl:time_mes}}\\ \hline
    ...
    Наивный
    байесовский
    классификатор       &75.5\%\cite{article9}80\%-92\%\cite{article4}    &    & \\ \hline
    Логическая
    регрессия           &93.4\%\cite{article9}    &    & \\ \hline
    Максимум энтропии   &72.6\%\cite{article9}95\%\cite{article4}    &    & \\ \hline
    k-ближайших соседей &    &    & \\ \hline
    Дерево решений      &    &    & \\ \hline
    Случайный лес       &88.39\%\cite{article9}    &    & \\ \hline
    Опорные векторы     &91.15\%\cite{article9}78\%-95\%\cite{article4}  &    & \\ \hline
    Нейронные сети      &87\%\cite{article9}    &    & \\ \hline
\end{longtable}
