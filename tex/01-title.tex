\begin{titlepage}
	...
	\begin{center}
        \textbf{НАУЧНО-ИССЛЕДОВАТЕЛЬСКАЯ РАБОТА}\\
        ~\\
        \fontsize{16pt}{16pt}\selectfont
        \text{«Обзор методов анализа тональности естественно-языковых текстов»}
	\end{center}
    ~\\
    ...
    \newline\newline
	\noindent\text{Научный руководитель}
    \uline{
            ~~~~~~~
        Оленев Антон Александрович
        ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    }
    \newline\newline
    ~\\
